        ...
        <div class="flex flex-col items-center flex-1 space-y-6">
            ...
            <nav class="flex flex-col items-center space-y-6">
                <router-link
                    ...
                    :class="{
                        'bg-white text-blue-700': $route.path === '/dashboard',
                    }"
                >
                    <svg
                        class="w-5 h-5 opacity-100 group-hover:stroke-blue-700"
                        viewBox="0 0 24 24"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
                        <rect
                            ...
                            stroke="#969CBA"
                            stroke-width="2"
                            class="group-hover:stroke-blue-700"
                        />
                        <rect
                            x="14"
                            y="3"
                ...
                <router-link
                    to="/"
                    class="p-3 transition-colors duration-300 rounded-lg rounded-lg group hover:bg-white"
                    :class="{
                        'bg-white text-blue-700': $route.path === '/',
                    }"
                >
                    <svg
                        class="w-5 h-5 opacity-100 group-hover:stroke-blue-700"
                    ...
                    >
                        ...
                        />
                        <path
                            d="M4 19c0-2.5 3.5-4.5 8-4.5s8 2 8 4.5v1H4v-1Z"
                            stroke="#969CBA"
                            stroke-width="2"
                            class="group-hover:stroke-blue-700"
                            fill="none"
                ...
                <router-link
                    ...
                    :class="{
                        'bg-white text-blue-700': $route.path === '/todo',
                    }"
                >
                    <svg
                        class="w-5 h-5 opacity-100 group-hover:stroke-blue-700"
                    ...
                    >
                        ...
                        <circle
                            ...
                            r="1"
                            fill="#969CBA"
                            class="group-hover:fill-blue-700"
                        />
                        <circle
                            cx="7"
                            cy="13"
                ...
                <router-link
                    ...
                    :class="{
                        'bg-white text-blue-700':
                            $route.path === '/saved-messages',
                    }"
                >
                    <svg
                        class="w-5 h-5 group-hover:stroke-blue-700"
                        viewBox="0 0 24 24"
                        fill="none"
                        xmlns="http://www.w3.org/2000/svg"
                    >
